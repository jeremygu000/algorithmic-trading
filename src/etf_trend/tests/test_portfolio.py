...
def test_constraints_weights_sum_to_one(sample_weights):
    ...
    测试约束后权重之和为 1
    """
    result = apply_constraints(sample_weights, max_single=1.0, max_core=1.0, core_symbols=[])
...
def test_constraints_single_cap(sample_weights):
    ...
    """
    result = apply_constraints(sample_weights, max_single=0.4, max_core=1.0, core_symbols=[])
...
def test_constraints_core_cap():
    ...
    result = apply_constraints(weights, max_single=1.0, max_core=0.5, core_symbols=["A", "B"])
...
def test_constraints_empty_weights():
    ...
    result = apply_constraints(weights, max_single=0.5, max_core=0.5, core_symbols=[])
...
def test_constraints_negative_weights_clipped():
    ...
    result = apply_constraints(weights, max_single=1.0, max_core=1.0, core_symbols=[])
