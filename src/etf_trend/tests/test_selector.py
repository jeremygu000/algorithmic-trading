...
from etf_trend.selector.satellite import StockSelector, StockSelectionResult
...
def test_selector_fundamentals_impact(mock_prices, mock_regime_risk_on, mock_fundamentals):
    ...
    score_tech = res_tech.candidates[0].signal_strength
    ...
    score_fund = res_fund.candidates[0].signal_strength
